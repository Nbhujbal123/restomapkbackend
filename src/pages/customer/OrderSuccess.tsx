...
const OrderSuccess: React.FC = () => {
  ...
  const orderId = location.state?.orderId || localStorage.getItem('lastOrderId') || 'FF123456789'
  const tableNumber = location.state?.tableNumber || localStorage.getItem('lastTableNumber') || null
                  ...
                  <div key={index} className="tracking-step d-flex align-items-center mb-4">
                    ...
                    {index < trackingSteps.length - 1 && (
                      <div className="tracking-line ms-3" style={{
                        width: '2px',
                        height: '40px',
                        background: index < currentStep ? '#4F46E5' : '#e9ecef',
