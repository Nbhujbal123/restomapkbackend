...
import { FaUser, FaEnvelope, FaLock, FaEye, FaEyeSlash, FaPhone, FaChevronLeft, FaBuilding } from 'react-icons/fa'
...
const Signup: React.FC<SignupProps> = ({ onClose, onSwitchToLogin, onSignup }) => {
  ...
  const handleOTPVerify = async (otp: string) => {
    try {
      ...
      // Store email for auto-fill in login
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '20px' }}>
          ...
          <div className="modal-body px-4 pb-4">
            ...
            {/* Site Code Indicator */}
            {siteCode && (
              <div className="alert d-flex align-items-center justify-content-center mb-3" style={{ 
                backgroundColor: '#e8f5e9', 
                border: '1px solid #4caf50',
                borderRadius: '8px',
                padding: '8px 12px'
              }}>
                <FaBuilding className="me-2" style={{ color: '#4caf50' }} />
                <span style={{ color: '#2e7d32', fontWeight: '600', fontSize: '14px' }}>
                  Signing up for: {siteCode}
                </span>
              </div>
            )}
