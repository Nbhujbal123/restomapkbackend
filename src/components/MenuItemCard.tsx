      ...
      <div className="flex h-full">
        ...
        <div className="flex-1 p-3 flex flex-col justify-between">
          <div>
            ...
            {/* Price */}
            <div className="font-bold" style={{ color: '#4F46E5', fontSize: '14px', fontWeight: 600 }}>
              ₹{item.price}
            </div>
            ...
            <div className="flex gap-1 mb-2">
              {(['Mild', 'Medium', 'Hot'] as const).map((spice) => (
                <button
                  ...
                  style={{
                    background: selectedSpiceLevel === spice ? '#4F46E5' : undefined
                  }}
                >
                  {spice}
                </button>
          ...
          <div className="flex justify-end">
            {currentQuantity === 0 ? (
              <button
                ...
                className="text-white px-4 py-1 rounded-full text-sm font-semibold hover:opacity-90 transition-all duration-200"
                style={{
                  background: '#4F46E5'
                }}
              >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-6 h-6 text-white rounded-full flex items-center justify-center text-sm hover:opacity-90 transition-colors duration-200"
